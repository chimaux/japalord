    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text
            className=" text-xl text-zinc-400 mx-4 my-4"
            style={{ fontWeight: "bold" }}
          >
            My Package
          </Text>
          ...
          >
            ...
            <View className="flex-row items-center">
              <View className="w-[70vw] bg-[#FFFBEB] rounded-full h-[45px]  flex-row items-center justify-between overflow-hidden my-4">
                <Text className=" ml-4 w-[60%]" numberOfLines={1}>
                  https:..easyjapa?ref/12345gnhgnhgnhfgngfnf
                </Text>
              ...
              <View className="ml-2 flex-wrap items-center">
                <Text className="text-[#6e002b]" style={{ fontWeight: "bold" }}>
                  Share
                </Text>
